...
class AirCargoProblem(Problem):
    ...
    def result(self, state: str, action: Action):
        ...
        for temp in old_state.pos:
            if temp not in action.effect_rem:
                new_state.pos.append(temp)

        for temp in old_state.neg:
            if temp not in action.effect_add:
                new_state.neg.append(temp)

        for temp in action.effect_rem:
            if temp not in new_state.neg:
                new_state.neg.append(temp)

        for temp in action.effect_add:
            if temp not in new_state.pos:
                new_state.pos.append(temp)
