...
class PlanningGraph():
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        for temp in node_a1.action.effect_add:
            if temp in node_a2.action.effect_rem:
                return True

        for temp in node_a1.action.effect_rem:
            if temp in node_a2.action.effect_add:
                return True
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        for temp in node_a1.action.effect_add:
            if temp in node_a2.action.precond_neg:
                return True

        for temp in node_a1.action.effect_rem:
            if temp in node_a2.action.precond_pos:
                return True

        for temp in node_a2.action.effect_add:
            if temp in node_a1.action.precond_neg:
                return True

        for temp in node_a2.action.effect_rem:
            if temp in node_a1.action.precond_pos:
                return True
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        for temp in node_a1.action.precond_pos:
            if temp in node_a2.action.precond_neg:
                return True

        for temp in node_a1.action.precond_neg:
            if temp in node_a2.action.precond_pos:
                return True

        for temp in node_a1.parents:
            for temp_2 in node_a2.parents:
                if temp.is_mutex(temp_2):
                    return True
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        for temp_1 in node_s1.parents:
            for temp_2 in node_s2.parents:
                if not temp_1.is_mutex(temp_2):
                    return False
